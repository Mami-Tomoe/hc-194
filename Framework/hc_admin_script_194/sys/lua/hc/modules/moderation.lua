...
hc.moderation.BUILDINGS = {
	{ title = "Barricades",           value = { hc.BUILDINGS.BARRICADE } },
	{ title = "Barbed Wire",          value = { hc.BUILDINGS.BARBED_WIRE } },
	{ title = "Walls",                value = { hc.BUILDINGS.WALL_I, hc.BUILDINGS.WALL_II, hc.BUILDINGS.WALL_III } },
	{ title = "Turrets",              value = { hc.BUILDINGS.TURRET, hc.BUILDINGS.DUAL_TURRET, hc.BUILDINGS.TRIPLE_TURRET } },
	{ title = "Teleporter Entrances", value = { hc.BUILDINGS.TELEPORTER_ENTRANCE } },
	{ title = "Teleporter Exits",     value = { hc.BUILDINGS.TELEPORTER_EXIT } }
}

--hc.moderation.IMAGE		= "gfx/hc/admin.png"

function hc.moderation.init()
	hc.add_menu_command("Identify", hc.moderation.id_command, hc.IDENTIFY_LEVEL, hc.ADMIN_MENU_KEY,
		{ category = "Check" })
	hc.add_menu_command("Supervise", hc.moderation.supervise_command, hc.SUPERVISE_LEVEL, hc.ADMIN_MENU_KEY,
		{ category = "Check" })

	hc.add_menu_command("Slap", hc.moderation.slap_command, hc.SLAP_LEVEL, hc.ADMIN_MENU_KEY, { category = "Discipline" })
	hc.add_menu_command("Slow Down", hc.moderation.slow_down_command, hc.SLOW_DOWN_LEVEL, hc.ADMIN_MENU_KEY,
		{ category = "Discipline" })
	hc.add_menu_command("Shake", hc.moderation.shake_command, hc.SHAKE_LEVEL, hc.ADMIN_MENU_KEY,
		{ category = "Discipline" })
	hc.add_menu_command("Mute", hc.moderation.mute_command, hc.MUTE_LEVEL, hc.ADMIN_MENU_KEY, { category = "Discipline" })
	hc.add_menu_command("Censor Name", hc.moderation.rename_command, hc.RENAME_LEVEL, hc.ADMIN_MENU_KEY,
		{ category = "Discipline" })
	hc.add_menu_command("Remove Buildings", hc.moderation.remove_buildings_command, hc.REMOVE_BUILDINGS_LEVEL,
		hc.ADMIN_MENU_KEY, { category = "Discipline" })
	...
	hc.add_menu_command("Ban IP/USGN/STEAM", hc.moderation.ban_command, hc.BAN_IP_USGN_STEAM_LEVEL, hc.ADMIN_MENU_KEY,
		{ category = "Remove" })
	hc.add_menu_command("Ban Name", hc.moderation.ban_name_command, hc.BAN_NAME_LEVEL, hc.ADMIN_MENU_KEY,
		{ category = "Remove" })
...
function hc.moderation.id(p, _, item)
	...
	if p == id then
		msg2(p,
			m ..
			", level: " ..
			hc.get_level_short_name(hc.get_level(id)) .. ", usgn: " .. usgn .. ", steam: " .. steam .. ", ip: " .. ip)
...
function hc.moderation.wall_cb(p, _, item)
	...
	hc.exec(p, "spawnobject " .. hc.BUILDINGS.WALL_III .. " " .. x .. " " .. y .. " 0 0 0 0")
end
